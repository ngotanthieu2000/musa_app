...
class SimpleAIAdvisorPage extends StatefulWidget {
  const SimpleAIAdvisorPage({Key? key}) : super(key: key);

  @override
  State<SimpleAIAdvisorPage> createState() => _SimpleAIAdvisorPageState();
}

class _SimpleAIAdvisorPageState extends State<SimpleAIAdvisorPage> {
  ...
  void _showAboutDialog() {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        title: const Text('About AI Advisor'),
        content: const Column(
          mainAxisSize: MainAxisSize.min,
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text(
              'AI Advisor analyzes your personality, goals, and behavior patterns to provide personalized advice.',
            ),
            SizedBox(height: 16),
            Text(
              'Features:',
            ...
            SizedBox(height: 8),
            Text('• Multi-perspective analysis from different advisor roles'),
            Text('• Personalized recommendations based on your AI Persona'),
            Text('• Continuous learning from your feedback and interactions'),
          ],
        ),
        actions: [
          TextButton(
